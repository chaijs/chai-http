 ...
 * ```
 *
 * #### Cleaning up request when your done
 *
 * If you need the clean up a request in your test you can simply call destroy
 * ```javascript
 * var requestApi = chai.request(app)
 * requestApi.put('/user/me')
 *   .send({ passsword: '123', confirmPassword: '123' })
 *   .then(function (res) {
 *      expect(res).to.have.status(200);
 *   })
...
module.exports = function (app) {
     ...
     * @param cb
     */
    obj.destroy = function destructor (cb) {
