describe('request', function () {
    ...
    it('should destroy a request object when created with an app when no request has been made', function (done) {
        var app = function (req, res) {
            req.headers['x-api-key'].should.equal('testing');
            res.writeHeader(200, {'content-type': 'text/plain'});
            res.end('hello universe');
        ...
        requestApi.destroy.should.be.an.instanceof(Function).and.have.property('name', 'destructor');
        requestApi.destroy(done);
    })

    it('should destroy a request object when created with an app a request has been made', function (done) {
        var app = function (req, res) {
            req.headers['x-api-key'].should.equal('testing');
            res.writeHeader(200, {'content-type': 'text/plain'});
            res.end('hello universe');
