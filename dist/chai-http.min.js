...
function o(e,t){return t&&(t=t.toLowerCase()),e.getHeader?e.getHeader(t):e.headers?e.headers[t]:void 0}function s(e){var t=c[e];n.addProperty(e,function(){new n(this._obj).to.have.headers;var e=o(this._obj,"content-type"),s="undefined"===h(e)?"headers":h(e);this.assert(e&&~e.indexOf(t),"expected "+s+" to include '"+t+"'","expected "+s+" to not include '"+t+"'")})}/*!
   * Module dependencies.
   */
var r=require("net"),a=require("qs"),i=require("url"),d=require("cookiejar"),n=e.Assertion,h=t.inspect;/*!
 ...
 * @api private
 */
function Test(e,t,s){Request.call(this,t,s),this.app=e,this.url="string"==typeof e?e+s:serverAddress(e,s)}function serverAddress(e,t){if("string"==typeof e)return e+t;var s=e.address();s||(e.listen(0),s=e.address());var r=e instanceof https.Server?"https":"http";return("0.0.0.0"===s.address||"::"===s.address)&&(s.address="127.0.0.1"),r+"://"+s.address+":"+s.port+t}/*!
 * agent
 *
...
"use strict";var v4="(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])(?:\\.(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])){3}",v6="(?:(?:[0-9a-fA-F:]){1,4}(?:(?::(?:[0-9a-fA-F]){1,4}|:)){2,7})+",ip=module.exports=function(e){return e=e||{},e.exact?new RegExp("(?:^"+v4+"$)|(?:^"+v6+"$)"):new RegExp("(?:"+v4+")|(?:"+v6+")","g")};ip.v4=function(e){return e=e||{},e.exact?new RegExp("^"+v4+"$"):new RegExp(v4,"g")},ip.v6=function(e){return e=e||{},e.exact?new RegExp("^"+v6+"$"):new RegExp(v6,"g")};
...
var Utils=require("./utils"),internals={delimiter:"&",depth:5,arrayLimit:20,parameterLimit:1e3};internals.parseValues=function(e,r){for(var t={},i=e.split(r.delimiter,r.parameterLimit),a=0,n=i.length;n>a;++a){var s=i[a],l=-1===s.indexOf("]=")?s.indexOf("="):s.indexOf("]=")+1;if(-1===l)t[Utils.decode(s)]="";else{var p=Utils.decode(s.slice(0,l)),c=Utils.decode(s.slice(l+1));t[p]?t[p]=[].concat(t[p]).concat(c):t[p]=c}}return t},internals.parseObject=function(e,r,t){if(!e.length)return r;var i=e.shift(),a={};if("[]"===i)a=[],a=a.concat(internals.parseObject(e,r,t));else{var n="["===i[0]&&"]"===i[i.length-1]?i.slice(1,i.length-1):i,s=parseInt(n,10);!isNaN(s)&&i!==n&&s<=t.arrayLimit?(a=[],a[s]=internals.parseObject(e,r,t)):a[n]=internals.parseObject(e,r,t)}return a},internals.parseKeys=function(e,r,t){if(e){var i=/^([^\[\]]*)/,a=/(\[[^\[\]]*\])/g,n=i.exec(e);if(!Object.prototype.hasOwnProperty(n[1])){var s=[];n[1]&&s.push(n[1]);for(var l=0;null!==(n=a.exec(e))&&l<t.depth;)++l,Object.prototype.hasOwnProperty(n[1].replace(/\[|\]/g,""))||s.push(n[1]);return n&&s.push("["+e.slice(n.index)+"]"),internals.parseObject(s,r,t)}}},module.exports=function(e,r){if(""===e||null===e||"undefined"==typeof e)return{};r=r||{},r.delimiter="string"==typeof r.delimiter?r.delimiter:internals.delimiter,r.depth="number"==typeof r.depth?r.depth:internals.depth,r.arrayLimit="number"==typeof r.arrayLimit?r.arrayLimit:internals.arrayLimit,r.parameterLimit="number"==typeof r.parameterLimit?r.parameterLimit:internals.parameterLimit;var t="string"==typeof e?internals.parseValues(e,r):Utils.clone(e),i={};for(var a in t)if(t.hasOwnProperty(a)){var n=internals.parseKeys(a,t[a],r);i=Utils.merge(i,n)}return Utils.compact(i)};

},{"./utils":18}],17:[function(require,module,exports){
(function (Buffer){
var internals={delimiter:"&"};internals.stringify=function(n,e){if(Buffer.isBuffer(n)?n=n.toString():n instanceof Date?n=n.toISOString():null===n&&(n=""),"string"==typeof n||"number"==typeof n||"boolean"==typeof n)return[encodeURIComponent(e)+"="+encodeURIComponent(n)];var r=[];for(var t in n)n.hasOwnProperty(t)&&(r=r.concat(internals.stringify(n[t],e+"["+t+"]")));return r},module.exports=function(n,e){e=e||{};var r="undefined"==typeof e.delimiter?internals.delimiter:e.delimiter,t=[];for(var i in n)n.hasOwnProperty(i)&&(t=t.concat(internals.stringify(n[i],i)));return t.join(r)};
